...
namespace LDFW
{
    ...
    public static partial class CommonExtensions
    {
        ...
        public static void SetParent(this Transform trans, Transform parent, Vector3 localPosition, string name = "")
        {
            trans.parent = parent;
        ...
        /// <param name="name"></param>
        public static void SetParent(this Transform trans, Transform parent, Vector3 localPosition, Vector3 localScale, string name = "")
        {
            trans.SetParent(parent, localPosition, name);
        ...
        {
            trans.SetParent(parent, localPosition, localScale, name);
        ...
        /// <summary>
        /// Transfer all of trans' children to another parent
        /// </summary>
        /// <param name="trans"></param>
        /// <param name="newParent"></param>
        public static void TransferChildren(this Transform trans, Transform newParent)
        {
            while (trans.childCount > 0)
                trans.GetChild(0).SetParent(newParent);
        }
        #endregion
        ...
        {
            return "(" + vec.x.ToString("0.000000") + ", " + vec.y.ToString("0.000000") + ")";
        }
        ...
        {
            return "(" + vec.x.ToString("0.000000") + ", " + vec.y.ToString("0.000000") + ", " + vec.z.ToString("0.000000") + ")";
        }
        ...
        {
            return "(" + vec.x.ToString("0.000000") + ", " + vec.y.ToString("0.000000") + ", " + vec.z.ToString("0.000000") + ", " + vec.w.ToString("0.000000") + ")";
        }
