            ...
            if (GUILayout.Button("Save to project"))
            {
                switch (currentMeshType)
                {
                    case MeshType.DoubleSidedPlane:
                        ...
                        LDFW.Tools.SaveToHardDrive.SaveMeshToFile(MeshGenerator.GenerateDoubleSidedPlane (planeSize, planeLengthSegmentCount, planeDepthSegmentCount), meshSavePath);
                        break;
                    case MeshType.Cube:
                    ...
                    case MeshType.Mesh:
                        ...
                        if (newMesh == null)
                            ...
                            LDFW.Tools.SaveToHardDrive.SaveMeshToFile(MeshGenerator.DuplicateMesh(targetMesh), meshSavePath);
                        break;
                }
            }
        }
